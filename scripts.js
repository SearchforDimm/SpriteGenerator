document.addEventListener("DOMContentLoaded", () => {
    ...
    function processImages() {
        ...
        if (layout === "vertical") {
            ...
            spriteWidth = images.reduce((sum, img) => sum + img.width + margin, 0) - margin;
            ...
            spriteHeight = numRows * Math.max(...images.map((img) => img.height)) + (numRows - 1) * margin;
        }

        console.log("Selected layout:", layout); // Debug: log selected layout
